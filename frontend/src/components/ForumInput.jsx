  ...
  return (
    <>
        ...
        <Form className="container col-10 py-5 my-0 justify-content-center align-items-around">
                <div>
                  <label for="email">Nombre del foro</label>
                ...
                <div>
                  ...
                  <div className="input-group mb-3">
                    <input type="text" className="form-control password-input" name="password" placeholder="''Si los ojos levantas, a la tierra no regresas.''" required/>
                  </div>
                </div>
